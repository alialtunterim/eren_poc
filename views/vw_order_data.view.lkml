# The name of this view in Looker is "Vw Order Data"
view: vw_order_data {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `looker_poc.vw_order_data` ;;
  ...
  dimension: cancel_refund_amount {
    type: number
  ...
  dimension: cancel_refund_without_tax_amount {
    type: number
  ...
  dimension: net_amount_without_tax {
    type: number
