# The name of this view in Looker is "C Products"
view: c_products {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `occasion-364007.looker_poc.c_products` ;;
  ...
  measure: total_attribute_set {
    type: sum
    sql: ${attribute_set} ;;  }
  measure: average_attribute_set {
    type: average
    sql: ${attribute_set} ;;  }
  ...
  dimension: is_seller_product {
    type: yesno
    description: "Is seller product"
    sql: ${TABLE}.is_seller_product ;;
  }
